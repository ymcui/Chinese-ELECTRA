...
- `ELECTRA-base`: 12层，隐层768，12个注意力头，学习率5e-4，batch1024，最大长度512，训练1M步
- `ELECTRA-small`: 12层，隐层256，4个注意力头，学习率2e-4，batch256，最大长度512，训练1M步
...
| 模型 | 开发集 | 测试集 | 挑战集 | 参数量 |
| :------- | :---------: | :---------: | :---------: | :---------: |
| BERT-base | 65.5 (64.4) / 84.5 (84.0) | 70.0 (68.7) / 87.0 (86.3) | 18.6 (17.0) / 43.3 (41.3) | 110M | 
| BERT-wwm | 66.3 (65.0) / 85.6 (84.7) | 70.5 (69.1) / 87.4 (86.7) | 21.0 (19.3) / 47.0 (43.9) | 110M | 
| BERT-wwm-ext | 67.1 (65.6) / 85.7 (85.0) | 71.4 (70.0) / 87.7 (87.0) | 24.0 (20.0) / 47.3 (44.6) | 110M | 
| RoBERTa-wwm-ext | 67.4 (66.5) / 87.2 (86.5) | 72.6 (71.4) / 89.4 (88.8) | 26.2 (24.6) / 51.0 (49.1) | 110M | 
...
| 模型 | 开发集 | 测试集 | 参数量 |
| :------- | :---------: | :---------: | :---------: |
| BERT-base | 83.1 (82.7) / 89.9 (89.6) | 82.2 (81.6) / 89.2 (88.8) | 110M | 
| BERT-wwm | 84.3 (83.4) / 90.5 (90.2) | 82.8 (81.8) / 89.7 (89.0) | 110M | 
| BERT-wwm-ext | 85.0 (84.5) / 91.2 (90.9) | 83.6 (83.0) / 90.4 (89.9) | 110M | 
| RoBERTa-wwm-ext | 86.6 (85.9) / 92.5 (92.2) | 85.6 (85.2) / 92.0 (91.7) | 110M | 
...
| 模型 | 开发集 | 测试集 | 参数量 |
| :------- | :---------: | :---------: | :---------: |
| BERT-base | 77.8 (77.4) | 77.8 (77.5) | 110M | 
| BERT-wwm | 79.0 (78.4) | 78.2 (78.0) | 110M | 
| BERT-wwm-ext | 79.4 (78.6) | 78.7 (78.3) | 110M |
| RoBERTa-wwm-ext | 80.0 (79.2) | 78.8 (78.3) | 110M |
| RBT3 | 72.2 | 72.3 | 38M | 
...
| 模型 | 开发集 | 测试集 | 参数量 |
| :------- | :---------: | :---------: | :---------: |
| BERT-base | 94.7 (94.3) | 95.0 (94.7) | 110M |
| BERT-wwm | 95.1 (94.5) | 95.4 (95.0) | 110M |
| BERT-wwm-ext | 95.4 (94.6) | 95.3 (94.7) | 110M |
| RoBERTa-wwm-ext | 95.0 (94.6) | 95.6 (94.8) | 110M |
| RBT3 | 92.8 | 92.8 | 38M | 
...
| 模型 | 开发集 | 测试集 | 参数量 |
| :------- | :---------: | :---------: | :---------: |
| BERT | 89.4 (88.4) | 86.9 (86.4) | 110M | 
| BERT-wwm | 89.4 (89.2) | 87.0 (86.8) | 110M |
| BERT-wwm-ext | 89.6 (89.2) | 87.1 (86.6) | 110M |
| RoBERTa-wwm-ext | 89.0 (88.7) | 86.4 (86.1) | 110M |
| RBT3 | 85.3 | 85.1 | 38M |
...
| 模型 | 开发集 | 测试集 | 参数量 |
| :------- | :---------: | :---------: | :---------: |
| BERT | 86.0 (85.5) | 84.8 (84.6) | 110M | 
| BERT-wwm | 86.1 (85.6) | 85.2 (84.9) | 110M |
| BERT-wwm-ext | 86.4 (85.5) | 85.3 (84.8) | 110M |
| RoBERTa-wwm-ext | 86.0 (85.4) | 85.0 (84.6) | 110M |
| RBT3 | 84.1 | 83.3 | 38M |
...
**Q: 有没有PyTorch版权重？**  
A: 暂时没有，建议等[HuggingFace-Transformers](https://github.com/huggingface/transformers)更新支持ELECTRA后我们会更新PyTorch版权重。
